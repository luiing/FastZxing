...
import com.uis.fastzxing.camera.CameraManager;
import com.uis.fastzxing.common.Scanner;
import com.uis.fastzxing.decode.DecodeFormatManager;
...
public class ScannerView extends FrameLayout implements SurfaceHolder.Callback {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        decodeFormats.addAll(DecodeFormatManager.parseDecodeFormats(Scanner.ScanMode.ONE_D_MODE));
    }
    ...
    private void onCameraOpen(boolean isOpen){
        if(onCameraOpenListener!=null){
            onCameraOpenListener.onCameraOpen(isOpen);
        }
    }
    ...
    public void setOnCameraOpenListener(OnCameraOpenListener l){
        this.onCameraOpenListener = l;
    }
